...
/**
 * @brief This sample provides the code implementation to perform boot and VBS NCrypt (KeyGuard) key attestation,
...
int main()
{
    ...
    try
    {
        ...
        auto vbs_key = create_key(MS_KEY_STORAGE_PROVIDER, REQUEST_KEY_NAME, NCRYPT_OVERWRITE_KEY_FLAG | NCRYPT_USE_VIRTUAL_ISOLATION_FLAG, true);
